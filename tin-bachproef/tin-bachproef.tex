...
\newcommand{\copromotor}{Anonymous}
...
% Datum van indienen
\newcommand{\datum}{08 January 2015}

% Faculteit
\newcommand{\faculteit}{Faculteit Bedrijf en Organisatie}

% Soort rapport
\newcommand{\rapporttype}{TODO: translate Scriptie voorgedragen tot het bekomen van de graad van\\Bachelor in de toegepaste informatica}
...
\newcommand{\examenperiode}{First examination period}
