...
Roslyn is a city in Washington, a former coal mining town and the filming location for multiple movies. It is also said that it was in this place, drinking one of Roslyn's beers, that a project manager on the Managed Languages team over at Microsoft came up with the name of their new \gls{compiler}: Roslyn.\parencite{Wischik2014} A compiler is a program that translates code from one language to another. In this case, it translates C\# code to \gls{msil} -- Microsoft Intermediate Language.
